...
void setDirection(int motorIndex, bool forward) {
  ...
  delayMicroseconds(50); // DIR settle time
}

// Returns true if completed, false if aborted by limit
